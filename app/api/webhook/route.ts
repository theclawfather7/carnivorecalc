...
function buildEmail(downloadLink: string): string {
  return [
    ...
    '<p style="color: #d6d3d1; line-height: 1.6;">Your purchase is confirmed. Here\'s your instant access link:</p>',
    '<div style="text-align: center; margin: 32px 0;">',
    '<a href="' + downloadLink + '" style="background: #dc2626; color: white; text-decoration: none; font-weight: 700; padding: 16px 32px; border-radius: 8px; display: inline-block; font-size: 16px;">🥩 Open Your Meal Plan →</a>',
    '</div>',
    ...
    '</ul></div>',
    '<p style="color: #78716c; font-size: 13px;">Tip: Use browser Print → Save as PDF to save permanently.</p>',
    '<hr style="border: none; border-top: 1px solid #1c1917; margin: 32px 0;" />',
    '<p style="color: #57534e; font-size: 12px; text-align: center;">CarnivoreCalc · Questions? Reply to this email.<br />',
    '<a href="https://carnivorecalc.com" style="color: #dc2626;">carnivorecalc.com</a></p>',
    '</div></body></html>',
  ].join('\n');
}
